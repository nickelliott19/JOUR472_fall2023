...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer** The column headers are not correct. 
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer** The column names are random and don't represent the data.
...
**Task** Run the codeblock below. What else do we need to do? **Answer** Assign names to the existing column headers.
