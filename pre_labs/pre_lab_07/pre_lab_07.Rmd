...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** Average Household Income by County in Maryland
...
Is the difference between Calvert and Montgomery significant? **Answer** Yes
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer** It seems that if the average household income is higher, the more students they have going to college.
...
**Task** What is another question you could ask of this data? **Answer** What counties have the highest increases in average household income and has that lead to an increase in students enrolled in college?
