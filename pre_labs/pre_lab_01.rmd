...
**Answer: 60712 observations or records or rows and 8 variables of columns**
...
third and fourth line is adding up all the records in each term in the dataset
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: In this codeblock, the term is sorted by the count_classes number, thus showing what terms have the most count_classes**
...
**Answer: In this codeblock, the terms are now sorted by the department and count_classes.**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer: This codeblock now includes the total number of seats available with the number of class in a term. The code also arranges the total seats in descending order given the (desc).**
...
Compared to the previous codeblock, what has changed and how did that affect the result? What do the top terms have in common? **Answer: This codeblock expands the table to include what was in the previous one but adding the mean seats or the average amount of seats available in a certain term and the median.**
...
**Answer: This codeblock is now grouping the data by department and not by term. Thus, the total, mean and median seats reference the department and the count of classes refer to each department as well instead of classes in a term it's classes for a certain department.**
...
1.  How can we group data to get a interesting/desirable result?

2.  How can we write code to configure/arrange data?

3.  What makes data useful and how can you determine it?
