...
**Task** Run the following code and describe the dataframe it outputs. **Answer** It outputs the dates of press releases with the url and the text.
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer** This finds words that are unique and keeps out the repetition of the words.
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer** This creates a table with all the words in the press release and in the order that they appear. 
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer** It is not that interesting because "the" is the most found word and that doesn't tell us anything unique. 
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer** This is way more interesting because it tells us more about the topic of the speech's rather than the literal amount of unique words used. 
...
**Task** Run the following code and describe the results. **Answer** This gives us seperate datasets of the year's 2021, 2022, and 2023. So we can see the prevalant topics discussed in each year. 
...
**Task** Run the following code and describe the results. **Answer** This gives us bigram's which combines two words together in context and shows us their prevalancy.
...
**Task** Run the following code and describe the results. **Answer** This is the same thing as before in giving us two words together is just now for 2022. 
...
**Task** Run the following code and describe the results. **Answer** Again giving us two words but for 2023 data. Except now covid-19 is not among the top 10 most discussed. 
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** I wouldn't say any of the sentiments are incorrect but possibly counter-intuitive. I think these words are used in both context of good and bad sentiment. Say protection is seen as a having good sentiment, you could say, "the protection has been outstanding", but then you could say, "the protection of our children is failing". 
