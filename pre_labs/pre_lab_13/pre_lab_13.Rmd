...
**Task** Run the following code and describe the dataframe it outputs. **Answer** This gives the per state education spending for each student in 2021, the GDP growth percentage, the population change, and which president the state voted for.
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer** The plot has a pretty weak correlation between population change and GDP growth.
...
**Task** Run the following code. Describe the plot. What do you see? **Answer** This is another weak correlation between per pupil spending and GDP growth. 
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer** I see that there is slight strength in the correlation between per pupil spending and GDP growth and per pupil spending and GDP growth. The rest are fairly weak.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer** I see the correlation and the p-value which suggests that the data is statistically significant.
...
**Task** Run the following code. Describe the model output. What do you see? **Answer** This is a very week correlation and the p-value suggests that it is not statistically significant.
...
**Task** Run the following code. Describe the table. What do you see? **Answer** I see that there was a slight increase in the GDP and per pupil spending under Biden but a lower population growth. 
...
**Task** Run the following code. Describe the output. What do you see? **Answer** I see that the data is not statistically significant because the p-value is .07
...
**Task** Run the following code. Describe the output. What do you see? **Answer** I see that the p-value suggests that the data is very statisically significant because it is so low. 
