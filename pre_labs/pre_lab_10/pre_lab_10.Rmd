...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** Two zipcode names and the zip name could be interesting.
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** This just contains the zipcodes in Maryland and their names.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is a detailed map showing the different zipcodes around Maryland.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This just downloads the census in a different way from tidycensus.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This just lets us see a plethora of data pertains to counties as well as the geography.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This just looks for the state number or code to show just Maryland counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is a map of Maryland showing the different counties.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is a detailed map that shows the different counties and zip codes of Maryland.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This cleans the foreclosure and zip code data and displays just the foreclosures by zip in march
...
**Task** Run the following code. Describe the output in the space below. **Answer** This joins the foreclosure data with the zip code data so we can see foreclosures in each zip code.
...
**Task** Run the following code. Describe the output in the space below. **Answer** We get a detailed color coded map of Maryland showing zip codes with different foreclosure rates.
...
**Task** Run the following code. Describe the output in the space below. Be sure to input your census api key. **Answer** This code just downloads the libraries necessary. SF accesses the geographic data. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** It accessed the census data to get foreclosures in Maryland. And the code changed the column names to county and notices. 
...
**Task** Run the following code. Describe the output in the space below. **Answer** This grabs census data which gives a population for every county.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This compares the two datasets so that we can see the differences in each variable name so we can adjust them so we can join them.
...
**Task** Run the following code. Describe the output in the space below. **Answer** Now we just have the county, population, and geometry without the variable and GEOID.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This joins the two data set so we can see the amount of foreclosures compared to the total population.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The below includes the rate by which the population goes into foreclosure.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The output produces a colored map with the different counties in Maryland. The darker shades of blue represent a lower rate of foreclosures.
...
**Task** Run the following code. Describe the output in the space below. **Answer** The color changed so that it is way easier to easily spot counties that have a larger or smaller rate of foreclosure.
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** There are not a lot of regional patterns. Charles County doesn't have a massive population but Baltimore City and Prince Georges County do have relatively large population yet all three have higher rates of foreclosure.
