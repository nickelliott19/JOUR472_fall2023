...
**A2:** There are 9775 records in the dataset and I would say the locations, the magnitudes, and time of year. 
...
**A3:** The depth is 669.98 and the magnitude is 4.2
...
**A7:** The column you want to look at is place and were 3427
...
**A8:** Earthquake and quarry blast are the most common
...
**A9:** It is unusual becase most of the earthquakes you hear on the news are much deeper while most earthquakes probably aren't newsworthy. Also, the other events being a negative depth seems odd. 
...
**A10:** Mutate the column to find just the hour
...
**A11:** Mutate and use case_when to see when a magnitude goes above 3 to label it as serious.
...
**A12**: We filter by serious earthquakes and then group by the hour. Then, we count those serious earthquakes and can arrange so we see the hour with the most serious earthquakes.
